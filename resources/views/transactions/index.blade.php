...
<div class="card shadow-sm">
    <div class="card-body p-0">
        ...
        @else
            <form method="POST" action="{{ route('transactions.reconcile') }}" id="bulk_reconcile_form">
                @csrf
                ...
                <table class="table table-striped table-hover align-middle mb-0">
                    ...
                    <tbody>
                        @foreach ($transactions as $transaction)
                            ...
                            <tr>
                                <td>
                                    <input type="checkbox" class="form-check-input transaction-check" name="transaction_ids[]" value="{{ $transaction->id }}" form="bulk_reconcile_form">
                                </td>
            ...
            <div class="p-3 border-top d-flex gap-2 flex-wrap align-items-center">
                <button class="btn btn-success" name="action" value="reconcile" type="submit" form="bulk_reconcile_form">Mark Reconciled</button>
                <button class="btn btn-outline-secondary" name="action" value="unreconcile" type="submit" form="bulk_reconcile_form">Unreconcile</button>
